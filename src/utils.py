...
def get_chat_response(args, input, key, org_id, n=1):
    ...
    while patience > 0:
        patience -= 1
        try:
            if args.model in ['gpt-3.5-turbo', 'gpt-3.5-turbo-0301', 'gpt-3.5-turbo-0613', 'gpt-4-0613', 'gpt-4o-mini', 'gpt-4o', 'gpt-4', 'gpt-4-turbo']:
            ...
            print('Authentication error, waiting to retry...')
            time.sleep(0.1) 
