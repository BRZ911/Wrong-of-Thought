...
"""
EOT_ERROR = r"""
Example of Python code error inference for this need to solve question:
Question: {question}
This is an error programming process: ’{reason_pot}‘.
Your answer cannot be the same as this error answer, please reflect on whether you have such an error!
